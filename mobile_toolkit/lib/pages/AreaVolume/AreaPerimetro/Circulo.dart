...
class APCirculo extends StatefulWidget {
  APCirculo({Key key}) : super(key: key);

  @override
  _APCirculoState createState() => _APCirculoState();
}
...
class _APCirculoState extends State<APCirculo> {
