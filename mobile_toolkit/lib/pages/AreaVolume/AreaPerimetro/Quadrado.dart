...
class APQuadrado extends StatefulWidget {
  APQuadrado({Key key}) : super(key: key);

  @override
  AP_QuadradoState createState() => AP_QuadradoState();
}
...
class AP_QuadradoState extends State<APQuadrado> {
