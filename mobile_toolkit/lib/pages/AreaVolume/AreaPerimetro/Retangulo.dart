...
class APRetangulo extends StatefulWidget {
  APRetangulo({Key key}) : super(key: key);

  @override
  _APRetanguloState createState() => _APRetanguloState();
}
...
class _APRetanguloState extends State<APRetangulo> {
